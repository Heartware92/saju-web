...
| taekil (택일) | ✅ Phase 5 완료 | (이번 commit) |
| date (지정일, category='period') | ✅ Phase 5 완료 | (이번 commit) |
| today (실시간) | 🔄 잡 처리기·route 준비됨, 페이지 적용 대기 | — |
| 더많은운세 (study·children·personality·name·dream) | 🔄 잡 처리기·route 준비됨, 페이지 적용 대기 | — |
| love·wealth·career·health·people | (비활성 — 옛 B안 폐지) | — |
| 타로 (3종) | ⏳ pending — tarot_records 별도 테이블 마이그레이션 필요 | — |
