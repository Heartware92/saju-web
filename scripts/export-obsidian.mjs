...
const TONES = {
  ...
  gangnim: ['산 몸으로 저승을 다녀와 염라대왕까지 잡아 온 전설의 차사', '씩씩한 해결사체 — "못 풀 일이 어디 있겠느냐". 단호하고 추진력 있게', "저승길·실마리·끝장. 시작했으면 끝을 본다는 임무 완수 서사 ('신과함께' 강림의 원형)"],
  dongja: ['신당의 영험한 꼬마 신령. 어른 신보다 맑게 본다', '아이 반말체 — "히히", "~지?", "~야". 덱 유일의 아이 화자, 돌려 말하지 않음', '사탕·천진함·첫 직감. 빙빙 돌리는 어른들 사이에서 정답을 툭 던짐'],
