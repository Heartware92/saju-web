...
/**
 * ★ 결정론적 톤 가드 — '정령이 내가 본다'는 관찰 전환구를 생성 후 제거.
 *   프롬프트 금지로도 계속 새어나오는 패턴이라 코드로 직접 strip.
 *   '당신을/사주를/OO님을 지켜보니·들여다보니·살펴보니' 류 관찰 도입절 + 문장 첫머리
 *   '들여다보니/지켜보니,' 일반형 + 페르소나가 안 쓰는 ** 굵게 마커를 제거한다.
 *   ('두고 지켜보다' 같은 일반 용법은 목적어가 없어 안전)
 */
