        ...
        <section className="space-y-6 text-[14px] text-text-secondary leading-relaxed">
          ...
          <Article title="제16조 (청약철회 및 환불)">
            <ol className="list-decimal pl-5 space-y-1">
              ...
              <li><strong>환불 처리는 결제 시 사용한 결제 수단으로만 가능하며(예: 신용카드 결제 → 신용카드 환불, 간편결제 → 동일 간편결제 환불), 현금 또는 다른 수단으로의 환급(환불)은 불가합니다.</strong></li>
              ...
              <li>유료 구매한 크레딧의 유효기간은 결제일로부터 1년이며, 유효기간이 경과한 크레딧은 환불 대상에서 제외됩니다.</li>
            </ol>
          </Article>
