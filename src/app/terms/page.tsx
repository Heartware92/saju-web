        ...
        <section className="space-y-6 text-[14px] text-text-secondary leading-relaxed">
          ...
          <Article title="제10조 (인공지능 생성 콘텐츠의 특성 및 면책)">
            <ol className="list-decimal pl-5 space-y-1">
              ...
              <li>인공지능가 생성한 모든 결과에 대해 회사는 그 정확성, 완전성, 신뢰성을 보장하지 않습니다.</li>
              <li>사주명리·운세·타로 등의 풀이는 과학적으로 효과가 입증된 것이 아니며, 오로지 참고 및 오락 목적으로만 제공됩니다.</li>
              <li>이용자는 인공지능가 생성한 결과를 바탕으로 내리는 모든 판단과 결정에 대해 본인이 전적으로 책임을 집니다.</li>
              <li>동일한 입력 정보라 하더라도 인공지능의 특성상 매번 다른 결과가 생성될 수 있으며, 이는 서비스의 결함이 아닙니다.</li>
              <li>회사는 인공지능 생성 결과의 이용으로 인한 직접적, 간접적, 부수적, 결과적 손해에 대하여 책임을 지지 않습니다.</li>
            </ol>
          </Article>
          ...
          <Article title="제20조 (부정 사용 제재)">
            <ol className="list-decimal pl-5 space-y-1">
              <li>자동화 수단을 이용하여 서버·인공지능 리소스를 무단으로 사용한 경우, 회사는 해당 회원의 서비스 이용을 제한할 수 있으며, 그로 인하여 회사에 발생한 손해의 배상을 청구할 수 있습니다.</li>
              <li>인공지능 시스템 프롬프트 해킹, 학습 데이터 추출, 모델 정보 탈취 등을 시도한 경우, 회사는 관련 법령에 따라 민·형사상 법적 조치를 취할 수 있으며, 이로 인하여 회사에 발생한 손해의 배상을 청구할 수 있습니다.</li>
            </ol>
          </Article>
          ...
          <Article title="제23조 (면책 조항)">
            <ol className="list-decimal pl-5 space-y-1">
              ...
              <li>회사는 인공지능가 생성한 풀이 결과의 정확성, 신뢰성, 유용성에 대하여 어떠한 보증도 하지 않으며, 회원이 이를 신뢰하여 발생한 손해에 대해 책임을 지지 않습니다.</li>
            </ol>
          </Article>
