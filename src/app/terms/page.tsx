        ...
        <section className="space-y-6 text-[14px] text-text-secondary leading-relaxed">
          ...
          <Article title="제2조 (정의)">
            ...
            <ol className="list-decimal pl-5 mt-2 space-y-1">
              <li>&quot;서비스&quot;란 회사가 웹사이트 및 모바일 앱을 통해 제공하는 정통사주, 신년운세, 오늘의 운세, 지정일 운세, 연도별 운세, 궁합, 택일, 토정비결, 자미두수, 타로, 이름풀이, 꿈해몽, 상담소 등 모든 사주명리·운세 풀이 콘텐츠 및 부가 기능을 의미합니다.</li>
              ...
              <li>&quot;달 크레딧&quot;(또는 &quot;크레딧&quot;)이란 서비스 내에서 콘텐츠 이용을 위해 사용되는 가상 재화로, 모든 풀이 콘텐츠(정통사주, 신년운세, 오늘의 운세, 지정일 운세, 연도별 운세, 궁합, 택일, 토정비결, 자미두수, 타로, 이름풀이, 꿈해몽, 상담소, 더 많은 운세 등)에 차감 단위로 사용됩니다.</li>
          ...
          <Article title="제8조 (서비스의 내용)">
            <ol className="list-decimal pl-5 space-y-1">
              <li>회사는 다음의 서비스를 제공합니다.
                <ul className="list-disc pl-5 mt-1 space-y-0.5">
                  <li>사주명리 기반 운세·풀이 콘텐츠 (정통사주, 신년운세, 오늘의 운세, 지정일 운세, 연도별 운세, 궁합, 택일, 토정비결, 자미두수, 타로, 이름풀이, 꿈해몽, 상담소, 더 많은 운세 등)</li>
