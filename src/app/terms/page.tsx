        ...
        <section className="space-y-6 text-[14px] text-text-secondary leading-relaxed">
          ...
          <Article title="제2조 (정의)">
            ...
            <ol className="list-decimal pl-5 mt-2 space-y-1">
              ...
              <li>&quot;달 크레딧&quot;이란 스탠다드 콘텐츠(실시간 운세, 타로, 더 많은 운세 등) 이용에 사용되는 크레딧을 말합니다.</li>
          ...
          <Article title="제16조 (청약철회 및 환불)">
            <ol className="list-decimal pl-5 space-y-1">
              ...
              <li>이미 크레딧을 사용하여 풀이 결과를 확인한 경우 해당 크레딧은 환불 대상에서 제외되며, 미사용 크레딧이 남아 있는 경우 그 부분에 대해서는 부분 환불을 신청할 수 있습니다.</li>
              <li>환불 요청은 고객센터(인앱 문의)를 통해 접수하며, 접수일로부터 3영업일 이내에 처리합니다.</li>
              <li><strong>환불 처리는 결제 시 사용한 결제 수단으로만 가능하며(예: 신용카드 결제 → 신용카드 환불, 간편결제 → 동일 간편결제 환불), 현금 또는 다른 수단으로의 환급은 불가합니다.</strong></li>
              <li>환불 시 결제 수수료, 이미 사용한 크레딧에 해당하는 금액 등을 공제한 나머지 금액을 환불합니다.</li>
              <li>무료로 지급된 크레딧(회원가입 보너스, 이벤트 등)은 환불 대상이 아닙니다.</li>
              <li>크레딧 유효기간(결제일로부터 1년)이 경과하여 자동 소멸된 크레딧은 본조 제1항의 청약철회 기간(7일)과 무관하게 환불 대상에서 제외됩니다(상세는 제14조 참조).</li>
            </ol>
          </Article>
