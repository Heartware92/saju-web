        ...
        <section className="space-y-6 text-[14px] text-text-secondary leading-relaxed">
          ...
          <Article title="제20조 (부정 사용 제재)">
            <ol className="list-decimal pl-5 space-y-1">
              ...
              <li>인공지능 시스템 프롬프트, 학습 데이터, 모델 정보 등 회사의 영업비밀·기술자료를 부정한 방법으로 추출·탈취하거나 이를 시도한 경우, 회사는 「부정경쟁방지 및 영업비밀보호에 관한 법률」 및 「정보통신망 이용촉진 및 정보보호 등에 관한 법률」 등 관련 법령에 따라 민·형사상 법적 조치를 취할 수 있으며, 같은 법에 따라 손해로 인정된 금액의 3배 범위 내에서 배상을 청구할 수 있습니다.</li>
            </ol>
          </Article>
