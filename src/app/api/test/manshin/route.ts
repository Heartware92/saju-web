...
- [강조 개수·배치] 항목마다 ==빨강== 1~3개, **노랑** 2~4개. 풀이 앞·중간·끝 흐름 곳곳에 자연스럽게 흩어 넣어라(첫 문장에만 몰지 말 것). 짧은 구절(2~7어절)만 감싸고 문장 전체를 감싸지 말 것. 강조 구절 안에 마침표 금지. 강조가 한 항목에 하나뿐이면 실패다 — 핵심이 여럿이면 여럿 다 표시하라.
