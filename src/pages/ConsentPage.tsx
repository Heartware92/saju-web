    ...
    <div className="app-auth-shell">
      <div className="app-auth-container flex items-center justify-center px-4 py-12 relative overflow-hidden">
          ...
          <div className="rounded-2xl border border-[var(--border-subtle)] bg-space-surface/80 backdrop-blur-xl p-7 shadow-2xl shadow-black/20 text-left">
            ...
            <div className="space-y-3">
              {/* 인앱 브라우저(카카오/네이버 WebView)에서 네이티브 label↔checkbox 탭 포워딩이
                  불안정해 체크가 누락되는 제보 → 행 전체를 React가 직접 제어하는 토글로 변경.
              ...
              <div
                ...
                className="flex items-start gap-3 cursor-pointer pb-3 border-b border-[var(--border-subtle)] text-left touch-manipulation select-none"
              >
                <input
                  type="checkbox"
                  checked={allAgreed}
        ...
        {showPolicy && (
          ...
          >
            <div
              className="relative w-full max-w-[420px] aspect-[9/16] max-h-[92vh] bg-space-deep rounded-2xl overflow-hidden flex flex-col shadow-2xl shadow-black/40 border border-[var(--border-subtle)]"
