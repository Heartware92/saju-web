...
★★★ 출력 형식 절대 규칙 — 4 sub-marker 사용:
  ...
  // [BACKLOG] axis_eumyang 5번째 sub-marker (수리 음양) — 청월당 비교 보강안.
  //   정통 4축 외 보조 분석이라 사용자 합의로 비활성. 부활하려면:
  //   1) 위 sub-marker 목록에 [axis_eumyang] 한 줄 추가 + "5 sub-marker" 로 변경
  //   2) 본문 자수 한자모드 680~880 로 증량 + axis_81 마지막 줄 제거
  //   3) 아래 [axis_eumyang] 룰 블록 활성화
  //   4) summary/strength/shadow 룰의 "4축" → "5축" 일괄
  //   5) MoreFortunePage 파티션 배열·split 정규식·NameSectionVisuals 5축 코드 활성화
...
/* [BACKLOG] axis_eumyang 룰 — 수리 음양 (정통 4축 외 보조 분석, 청월당 비교 보강안)
   사용자 합의로 비활성화. 부활 시 위 axis_81 룰의 "4축 종합" → "5축 종합" 변경하고 아래 활성:

[axis_eumyang] 수리 음양
${isHanjaMode
  ? '한자 획수의 홀짝(홀수=양, 짝수=음) 배열로 본 음양 균형 단정 3~4문장.\n  · 각 한자 획수가 양인지 음인지 단정.\n  · 음양 분포 평가.\n  · 본인 사주의 음양 분포(천간·지지 음양 비율)와 닿거나 어긋나는 지점.\n  · 마지막 한 줄: "5축 종합으로 가장 강한 축은 ○○이고, 가장 약한 축은 △△입니다." 단정.'
  : '한자 획수가 없어 음양 배열 분석은 불가합니다. (한 문장으로 끝)\n  마지막 한 줄: "현재 5축 중 음령오행 1축만 분석되어 종합 판정은 제한적입니다." '}
*/
