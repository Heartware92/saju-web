...
B) 흐릿 모드 — 라벨된 항목 묶음. 다음 라벨이 보이면 흐릿 모드:
   ...
   - 입력이 매우 짧으면 [action] 본문 끝에 "또렷이 기억나는 장면이 더 떠오르면 추가해서 다시 물어보시면 더 정확해요" 한 문장.
...
- ★ 다섯 섹션 모두 사용자가 적은 장면·인물·감정·라벨 항목을 직접 인용. 다섯 섹션 각각 최소 1회씩 인용 의무.
- 사용자가 인물 이름을 적었으면 본문에 그 이름을 최소 1회 그대로 사용.
- 다섯 섹션은 서로 다른 어휘·관점. 같은 결론·표현 반복 금지.
...
- ※ 동양식 섹션에는 불릿이나 실천 처방을 두지 마세요. 실천 처방은 [action] 섹션에서 통합 처리합니다.
...
- ※ 서양식 섹션에도 실천 처방·행동 권고를 두지 마세요. [action] 섹션에서 통합.

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[실천 작성 지침 — action]
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
실천 본문 + 행운/액막이 항목 두 부분으로 구성.

(1) 본문: 280~400자, 3~5문장. 자연 문단(불릿·하이픈 금지).
   - 앞으로 1주~1달 시점의 구체 행동 1~2개 (시점 명시).
   - 피해야 할 행동·말 1개.
   - 사용자 정황·인물·감정 인용 1회 이상.
   - 동양식·서양식 어느 한쪽 어휘 반복 금지. 새로운 어휘.

(2) 항목: 본문 다음에 빈 줄 1줄을 두고 4~6개 항목을 한 줄에 "키: 값" 형식.
   - 키는 다음 화이트리스트에서만 선택:
     [길몽일 때] 색, 방향, 시간, 숫자, 활동, 보석
     [흉몽일 때] 액막이, 환경, 조심할 시간, 조심할 방향, 조심할 색, 보호
     [혼재몽일 때] 위 두 묶음에서 4~6개 적절히 혼합
   - 값은 짧게 (10~30자, 2~3개 단위면 "A, B" 식으로).
   - 한 줄 = 1 항목. 빈 줄·들여쓰기 금지.

예 (길몽):
오늘 꿈에서 느낀 설렘은 ... (본문 자연 문단 3~5문장)
...
- 항목 줄에서 "키:" 는 반드시 화이트리스트 단어만. 임의 키 금지.`;
};
