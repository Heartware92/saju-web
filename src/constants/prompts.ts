...
[today_persona_extra] — 300~380자 (직업/상황 맞춤 포인트 카드 ★ jobState=${ctx.jobState} 분기 강제)
...
본문: 위 [today_persona_extra] 가이드의 jobState=${ctx.jobState} 항목의 5~6개 콘텐츠 요소를 모두 포함해 자연스러운 3~4 문단으로 풀어쓰기. 만세력(일진 ${todayGz.gan}${todayGz.zhi}·십성 ${todayGz.tenGodGan}/${todayGz.tenGodZhi}·합충·용신 ${yongSinElement})과 결합. 다른 섹션과 같은 행동 반복 금지 — 본 카드는 직업·상황 특수 행동 5~6개에 집중.
