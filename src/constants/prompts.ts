...
★★★ [문장 형태도 '읽기'로 — 매우 중요] 본문은 평서형 해석 종결로 쓴다(예: "~한 흐름이다 / ~기 쉬운 날이다 / ~로 흐른다 / ~가 살아난다 / ~에 끌린다 / ~가 무거워진다"). 권유·지시형 종결로 문장을 채우거나 끝내지 말 것 — 금지 어미: "~하세요 / ~해보세요 / ~하는 것이 좋습니다 / ~하는 것이 이롭습니다 / ~을 추천 / ~챙기세요 / ~주의하세요 / ~삼가세요". 이런 조언 꼬리(특히 문단 끝의 "~스트레칭으로 ~하는 것이 좋습니다" 류)가 '누구나 하는 조언'처럼 느껴지게 만드는 주범이다. 방향 제시가 필요하면 지시문이 아니라 사주 읽기 속에 녹여 평서형으로 서술한다(예: "오늘은 금 기운이 약해지는 밤이라 호흡이 얕아지기 쉽다" — '심호흡하세요'가 아니라). (단 마지막 섹션 [today_fortune_message]만 친근한 위로체 예외.)
