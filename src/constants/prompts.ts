...
- 그 다음 줄들이 isHanjaMode 면 "[summary] [eum_ryeong] [ja_won] [harmony] [numerology] [advice]" 6개, 한글 전용이면 "[summary] [eum_ryeong] [harmony] [advice]" 4개 마커를 각 섹션 앞에 단독 줄로 출력.
...
(빈 줄)
본문 200~280자 — 줄글 한 단락으로 풍부하게:
  · 결론 한 줄: 이름이 사주를 돕는가·중립인가·거스르는가 (단정적으로)
  · 음령오행 분포가 사주(용신·기신)와 어떻게 맞물리는지 1~2문장
  · 자원오행이 보강하는 지점 1문장 (한자 모드일 때)
  · 81 수리 4격 중 가장 강한 격 + 가장 약한 격 한 문장씩
  · 일상에서 어떻게 발현되는지 또는 어떤 시기·영역에서 빛나는지 1문장
  ★ 다른 섹션들은 시각 카드가 옆에 있어 본문이 짧으므로, summary 만 종합적·서사적으로 풍부하게.
