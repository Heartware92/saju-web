...
(빈 줄)
본문 130~180자 — 학업 체질을 한 줄로 단정(암기형/사고형/표현형/독학형 중 하나)하고 그 체질이 일상에서 어떻게 나타나는지 자연스럽게 풀어쓰기. 격국·십성 근거 1~2개를 같은 호흡에 녹이고, 본인이 공부할 때 보이는 자연스러운 행동을 묘사. 십성 용어는 일상어로 즉시 풀이. 추상 격언 금지.
