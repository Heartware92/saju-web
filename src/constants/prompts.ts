...
■ 모든 ▶ 섹션의 첫 줄에 반드시 "[은유]" 마커를 붙인 은유 부제목을 작성하세요.
  앱이 "[은유]" 텍스트를 파싱하여 부제목을 추출하므로, 마커가 없으면 은유가 표시되지 않습니다.

■ 형식 (반드시 준수):
▶ 섹션 제목
[은유] 은유 부제목 (7~20자, 명사구·체언 종결)
...
■ 부제목 금지 사항:
✗ "[은유]" 마커 누락 → 절대 금지. 은유를 적더라도 마커 없으면 인식 불가
...
■ 출력 점검: 모든 ▶ 섹션의 첫 줄이 "[은유]"로 시작하는지 확인 후 출력하세요.
"[은유]" 마커가 없는 섹션이 하나라도 있으면 전체 풀이가 실패로 간주됩니다.`;
