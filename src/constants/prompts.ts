...
[axis_eum] 음령오행
${koreanInitialsElements.join('·') || '(분석 불가)'} 분포가 사주(용신 ${yongSinEl}·기신 ${result.giSin}·신강신약 ${result.strengthStatus})와 어떻게 맞물리는지 단정 2~3문장. 어느 초성이 어느 오행을 어디서 보태는지 + 약점도 함께.
...
[axis_81] 81수리 4격 길흉
${isHanjaMode
  ? '원격→형격→이격→정격을 각각 "○○수는 ○○에 해당" 형식으로 한 번 인용 + 결 1~2문장 (총 6~8문장). 예) "원격은 15수로 대길에 해당", "형격은 20수로 흉에 해당". 격마다 인생 시기·영역에서 어떻게 발현되는지 구체 묘사. **대괄호 [ ] 절대 사용 금지 — 모두 자연어로**.\n마지막 한 줄: "4축 종합으로 가장 강한 축은 ○○이고, 가장 약한 축은 △△입니다." 단정.'
