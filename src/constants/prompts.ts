...
[western_mirror]
이 섹션은 두 부분으로 구성됩니다 — 반드시 둘 다 출력:

▣ 부분 1: 본문 9~13문장 (550~800자). Continuity + 보상 + 동시성. 일상·관계·고민·직장·가족 가설 3~4 + 무의식 메시지 영역별 풀이 + 의식의 일방성 보상 + 동시성 한 줄 + 결론 + 1주 안 작은 신호.

▣ 부분 2: 본문 다음 빈 줄 1줄 + 매핑 라인 3~4개. ★★★ 절대 누락 금지 — 매핑 카드 비어 보이는 사고 ★★★
