...
- **형제·동료 단락(4단락)**: 비겁(비견·겁재) 배치로 본 형제·동료 관계 1~2문장. 무난·경쟁·성장 중 어느 결인지 명리 근거로 노출
...
- **귀인 vs 거리 두기(7단락)**: 의지하면 좋은 사람 유형 1개 + 거리 두어야 하는 유형 1개를 십성·오행 근거로 (예: "인성 보강해주는 어른형이 귀인", "식상 과한 즉흥형은 에너지 소모")
마지막 문장에서 제목 은유 회수.
