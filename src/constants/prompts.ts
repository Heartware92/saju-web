...
· [★★★ 표현 = '체감 비유'를 명리 해석에 녹이기 — 가장 중요]
    ...
    · ★ 감정↔현상 '짝짓기 사전'(돌려쓰기, 같은 짝 두 번 금지): 벅참·충만=달 차오름·강이 바다에 닿음·꽃 만개 / 설렘·기대=별똥별 스침·첫눈·새싹 움틈 / 상쾌·각성=첫 햇살·이슬 머금은 아침·바람이 트임 / 평온·안정=잔잔한 호수·뿌리내린 나무·산이 등 뒤에 섬·화로 온기 / 든든=거목·바위 / 답답·정체=구름에 가린 달·얼어붙은 샘·안개에 묻힌 길 / 단단·의지=벼려진 강철·깎인 보석 / 따뜻·포용=봄볕·모닥불·품는 바다.
