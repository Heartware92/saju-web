...
[작성 지침] 7개 섹션 구조 — 각 섹션은 반드시 [key] 마커 줄로 시작. 총 본문 ${isHanjaMode ? '2400~3200' : '2100~2800'}자. 5달 가치에 맞게 풍부하게.
- 각 섹션 본문은 명시된 최소치 미만으로 작성 금지 (미만이면 양면 묘사·구체 장면 추가해 채울 것).
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[oriental_domains — 6 영역 점수와 한 문장]
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
정확히 다음 6줄 (라벨 변경 금지, 한 줄 1영역):

재물=점수 | 한 문장 풀이 (20~50자)
인연=점수 | 한 문장 풀이
건강=점수 | 한 문장 풀이
시험·학업=점수 | 한 문장 풀이
직장·일=점수 | 한 문장 풀이
...
2~4문장 자연 문단. 다음 내용을 포함:
- 그 시진의 동양 전통 의미 (영험도, 정몽/사몽/잡몽 경향)
- 이 꿈이 그 시진에 꾼 것이 해석에 어떻게 무게를 더하는지
- "${sijinInfo.note}" 같은 시진 노트를 한 번 인용`
  : `사용자가 시각을 입력하지 않았습니다. 다음 한 문장만 출력:
"꿈꾼 시각을 알려주시면 시진(時辰)의 영험도까지 결합해 더 정밀하게 풀어드릴 수 있어요."`}

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[oriental_advice — 이렇게 해보세요]
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
(1) 본문 3~5문장: 1주~1달 안의 구체 실천 1~2개. 격려·응원 톤.
   - 사용자 정황·인물·감정을 한 번 인용.
   - 동양식 어휘 (음양오행·기운·인연·재물) 톤.

(2) 빈 줄 1줄.

(3) "키: 값" 항목 4~6개 (한 줄 = 1항목). 키 화이트리스트:
   [길몽/혼재] 색 / 방향 / 시간 / 숫자 / 활동 / 보석 / 음식
   [흉몽] 액막이 / 환경 / 조심할 시간 / 조심할 방향 / 조심할 색 / 보호
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
3~5문장 차분한 경고 톤. 자연 문단. 불릿·하이픈 금지.
- 이 꿈이 시사하는 함정·과신·놓치기 쉬운 부분.
- 피해야 할 행동·말·관계 1~2가지 구체.
- 사용자 단어 1회 이상 인용.
...
그 다음 빈 줄 1줄.
2~4문장 자연 풀이: 왜 의식이 이렇게 위장했는지, 어떤 욕망·검열이 작동했는지. Freud 용어("억압된 욕망", "소망 성취", "에고 아이덜")는 한국어 부연과 함께 1~2개만.
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
3~5문장 자연 문단. Continuity Hypothesis 관점.
- 최근 사용자의 일상·관계·고민 중 어떤 부분이 이 꿈 모티프에 비치는지 1~2개 가설.
- 무의식이 보내는 메시지 한 문장.
- 의식의 일방성을 보상하는 측면이 있다면 "당신의 의식이 ~을 외면해 무의식이 ~로 보여준 듯" 톤.
- 사용자가 적은 단어 1회 인용.
- 융 동시성(Synchronicity) 가능성을 한 줄 언급해도 좋음(현실의 만남·기회 예고).
...
(A) 게슈탈트 1인칭 워크 — 기본
꿈에 등장한 인물·동물·사물 중 가장 강렬했던/거부감이 컸던 한 가지를 골라 "1인칭으로 되어 말해보기". 3~5문장:
- "${'\''}나는 [그 ○○]이다. 나는 ___을 원한다. 나는 너에게 ___을 전하러 왔다${'\''}" 같은 대본 1~2줄을 한국어로 풀어 제시.
- 그 워크가 어떤 자기 부분을 통합하는지 한 문장 안내.

(B) IRT 다시쓰기 — 반복몽·악몽 분류일 때만
- 부정적 결말 부분만 안전·자율적 결말로 다시 쓰는 가이드.
- "낮 동안 5분씩 2~3주 새 시나리오를 시각화" 같은 실천 방법 1줄.
