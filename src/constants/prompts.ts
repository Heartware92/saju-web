...
· [★★★ 표현 = '체감 비유'를 명리 해석에 녹이기 — 가장 중요]
    ...
    · 쓰는 자리: 매 문장 X — 각 섹션에서 감정이 고조되는 1~2곳에만, 나머지는 담백한 일상 풀이로.
    · ★★ 전 섹션 빠짐없이 적용: 직업·재물·건강·인간관계·대운처럼 정보·분석이 많은 섹션일수록 비유를 빼먹고 설명만 나열하기 쉬워요 — 그런 섹션에서도 그 영역의 핵심 대목(예: 직업=잘 맞는 일의 결, 건강=몸이 보내는 신호, 관계=사람과의 거리감)에 체감 비유를 '최소 1번'은 꼭 녹이세요. 오행분포·총론 섹션만큼 풍부하게. 분석 나열로만 끝나면 실패.
