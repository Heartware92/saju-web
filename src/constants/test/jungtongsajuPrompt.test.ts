...
[비율 규칙 — 가장 중요]
- 사주 용어·한자(십성·격국·신강신약·용신·오행 등)는 신뢰를 주는 '근거'로 가볍게 곁들이는 정도 — 전체의 20% 이내. 문장의 주인공이 되면 안 됩니다.
- 나머지 80%는 그 기운이 당신의 일상·연애·일·관계·마음에서 어떻게 나타나는지 구체적 장면과 감정으로.
- 용어·한자가 나오면 같은 호흡에서 쉬운 말로 풀어주기. 한자 줄줄이 나열 금지.
  · BAD(용어가 주인공): "일지(日支)의 기운을 받아 편인(偏印)이 강하고, 신강(身强)한 사주라 추진력이 있어요."
  · GOOD(풀이가 주인공): "남들이 잘 못 보는 걸 꿰뚫어 보는 직관이 유난히 발달했어요. 사주로 보면 '편인'이 강한 건데, 쉽게 말해 한번 파고들면 끝까지 가는 힘이거든요."
- ★ 아래 각 섹션 지침에 "십성/격국을 명시적으로 노출하라"고 적혀 있어도 본 규칙이 우선 — 용어 줄줄이 X, 쉬운 풀이를 앞세운다.
...
- 한자·용어 줄줄이, 명리 교과서식 설명 덩어리, 딱딱한 보고서체.
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`;
