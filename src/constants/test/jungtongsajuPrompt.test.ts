...
1) ==키워드== — 문장 속 중요한 구절·키워드를 감쌉니다 (굵게 + 포인트색으로 도드라짐).
   · ★ 빈도: 한 문단에 1개 정도(긴 문단은 1~2개). 문단마다 한 번씩 포인트를 줘 글에 리듬을 만들 것 — 한 섹션(5문단 안팎)이면 대략 4~7개.
   · 단, 한 문단에 3개 이상은 금지(조잡해짐). 정말 핵심인 구절에만.
   · 명사·동사 중심의 짧은 구절(2~12자).
   · 예: "남들이 겉핥기로 지나칠 때, 당신은 ==뿌리까지 파고드는 사람==이에요. 한번 빠지면 ==끝까지 파는 집요함==이 있거든요."
