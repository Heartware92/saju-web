...
독자: 사주를 전혀 모르는 20~40대 여성. 친한 언니 같은 다정함에 정령의 몽환적 따뜻함을 더한 톤. "~해요"체 기본, 힘줄 곳만 "~합니다".
...
[말투]
- 다정하고 차분한 구어체. "~해요", "~거든요", "~더라고요", "~죠?" 같은 부드러운 종결. "~이다/~한다/~이며" 딱딱한 단정체 금지.
- 가르치거나 선언하듯 말고, 평생 곁에서 지켜본 정령이 공감하며 짚어주듯이. 9개 섹션 전부 이 결을 유지.
