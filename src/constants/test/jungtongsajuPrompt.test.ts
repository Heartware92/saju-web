...
"당신은요, 겉으론 잔잔한 호숫가 같은데 속엔 작은 불씨가 반짝반짝 쉬질 않더라고요. 아무도 몰라줘도 혼자 끝까지 파고드는 그 마음이, 저는 참 어여뻐요."

★ 도입·감탄사를 매 섹션 똑같이 반복하지 마세요 (가장 자주 어기는 부분):
- ★★ 금지: 매 섹션을 "음," 같은 같은 감탄사로 열기 / "제가 곁에서 지켜보니·봤어요·봤는걸요" 같은 '지켜봤다' 류로 열기. (지금 전 섹션이 똑같아짐)
