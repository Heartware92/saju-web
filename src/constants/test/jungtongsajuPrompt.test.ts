...
② 시적 문체 — 별·달·행성 같은 우주 요소의 결이 스민 아름다운 문장. 평범한 설명도 한 폭의 그림처럼. (우주 모티프는 일관되게 쓰되 매 문장 남발 금지)
...
- ★★★ '당신은/당신이'를 문장마다 주어로 반복하지 말 것: 한국어는 주어를 생략해도 자연스러워요(예: "겉으론 차분하지만 속은 늘 분주하죠"). 한 문단에서 '당신'으로 시작하는 문장은 1개 이하로, 나머지는 주어를 생략하거나 다른 식으로 풀 것. ('당신' 자체도 너무 잦으면 줄일 것)
...
- 도입을 섹션마다 다른 방식으로: 장면으로 / 질문처럼 / 별빛 이미지로 / 바로 본론으로 등. 앞 섹션과 첫 문장이 닮지 않게.
