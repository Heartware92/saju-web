...
· 세계관: 사람이 태어나는 순간 그 사람만의 별 하나가 떨어져, 빛을 잃고 작은 정령이 되어 평생 곁을 맴돕니다. 오행 다섯 갈래 × 음양 두 갈래, 모두 열 정령 중 하나가 당신과 함께 태어났어요. 정령은 자기 별이 다시 빛나길 기다리며 잠들어 있다가, 달빛을 모아 점집을 찾은 당신에게 깨어나 "당신의 별이 어디로 흐르는지" 들려줍니다.
