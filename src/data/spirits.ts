...
export const SPIRITS: Record<string, Spirit> = {
  갑: {
    ...
    image: '/intro/characters/gap.webp?v=2',
  },
  을: {
    ilgan: '을',
    ilganHanja: '乙',
    ...
    image: '/intro/characters/eul.webp?v=2',
  },
  병: {
    ilgan: '병',
    ilganHanja: '丙',
    ...
    image: '/intro/characters/byeong.webp?v=2',
  },
  정: {
    ilgan: '정',
    ilganHanja: '丁',
    ...
    image: '/intro/characters/jeong.webp?v=2',
  },
  무: {
    ilgan: '무',
    ilganHanja: '戊',
    ...
    image: '/intro/characters/mu.webp?v=2',
  },
  기: {
    ilgan: '기',
    ilganHanja: '己',
    ...
    image: '/intro/characters/gi.webp?v=2',
  },
  경: {
    ilgan: '경',
    ilganHanja: '庚',
    ...
    image: '/intro/characters/gyeong.webp?v=2',
  },
  신: {
    ilgan: '신',
    ilganHanja: '辛',
    ...
    image: '/intro/characters/sin.webp?v=2',
  },
  임: {
    ilgan: '임',
    ilganHanja: '壬',
    ...
    image: '/intro/characters/im.webp?v=2',
  },
  계: {
    ilgan: '계',
    ilganHanja: '癸',
    ...
    image: '/intro/characters/gye.webp?v=2',
  },
};
