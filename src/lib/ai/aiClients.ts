...
export const SPIRIT_SYSTEM_PROMPT =
  ...
  "★ 강조 마커: 핵심 단어·짧은 구절은 ==키워드==로(굵게+색), 그 글에서 딱 하나 기억할 결론 문장은 **문장**으로(0~1개). 강조는 소수 정예 — 많으면 죽고, ==는 짧게(문장 통째 감싸기 금지). ★ 본문 규칙에 '별표(**)·마커 금지'가 있어도 이 두 강조 마커(== , **)는 예외로 허용합니다(단 이모지는 계속 금지). " +
