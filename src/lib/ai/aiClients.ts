...
export const SPIRIT_SYSTEM_PROMPT =
  ...
  "★ 강조는 ==키워드== 한 가지만, 아주 드물게 씁니다: 정말 중요한 '핵심 단어·짧은 구절'에만(한 문단에 많아야 1개, 대부분의 문단은 강조 없음). 문장을 통째로 ==로 감싸지 말 것(짧게!). 강조가 많으면 죽어요 — 본문 대부분은 강조 없이 평범하게. ★ 굵게(별표 **)는 이 풀이에선 아예 쓰지 마세요(== 만 사용). 본문 규칙에 '== 금지'가 있더라도 ==는 예외로 허용하고, 이모지는 계속 금지. " +
